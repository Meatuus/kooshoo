$(function() {
    ...
    $('.facebook').on('click', function() {
        var w = 580, h = 300,
            ...
            if ((screen.width < 480) || (screen.height < 480)) {
                window.open ('http://www.facebook.com/share.php?u=https://www.kickstarter.com/projects/1447416823/kooshoo-feeling-good-every-step-of-the-journey', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
            } else {
                window.open ('http://www.facebook.com/share.php?u=https://www.kickstarter.com/projects/1447416823/kooshoo-feeling-good-every-step-of-the-journey', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);   
            }
    });
    ...
    $('.twitter').on('click', function() {
        var loc = encodeURIComponent('http://kck.st/1gOrpvs'),
                title = "12 outfits in 1 - that's creative design! Help my friends at @Kooshoo make it happen: ",
                w = 580, h = 300,
                left = (screen.width/2)-(w/2),
                top = (screen.height/2)-(h/2);
    ...
    $('.play').on('click', function() {
        window.location.href = "http://kck.st/1gOrpvs";
    });
